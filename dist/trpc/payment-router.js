...
exports.paymentRouter = (0, trpc_1.router)({
    createSession: trpc_1.privateProcedure.input(zod_1.z.object({ productsIds: zod_1.z.array(zod_1.z.string()) })).mutation(function (_a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        line_items.push({
                            price: "price_1OY8y5GY6lFKF0k37mOCw2Xh",
                            quantity: 1,
                            adjustable_quantity: {
                                enabled: false,
                            }
